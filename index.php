...
<div class="col-lg-3 col-md-8 " data-aos="zoom-in" data-aos-delay="100">
  <div class="box">
    ...
    <img src="assets/gambar/tempe.jpg" class="img-fluid rounded-circle" style="width:300px;" alt="">
<hr>
...
<div class="box">
   ...
   <img src="assets/gambar/sate.jpg" class="img-fluid rounded-circle" style="width:300px;" alt="">
<hr>
   <span id="boot-icon" class="bi bi-star" style="font-size: 19px; color: rgb(255, 210, 48); opacity: 1; -webkit-text-stroke: 0px rgb(251, 255, 0);"></span>
   <span id="boot-icon" class="bi bi-star" style="font-size: 19px; color: rgb(255, 210, 48); opacity: 1; -webkit-text-stroke: 0px rgb(251, 255, 0);"></span>
   <span id="boot-icon" class="bi bi-star" style="font-size: 19px; color: rgb(255, 210, 48); opacity: 1; -webkit-text-stroke: 0px rgb(251, 255, 0);"></span>
...
<div class="box">
   ...
   <img src="assets/gambar/susu.jpg" class="img-fluid rounded-circle" style="width:300px;" alt="">
<hr>
   <span id="boot-icon" class="bi bi-star" style="font-size: 19px; color: rgb(255, 210, 48); opacity: 1; -webkit-text-stroke: 0px rgb(251, 255, 0);"></span>
   <span id="boot-icon" class="bi bi-star" style="font-size: 19px; color: rgb(255, 210, 48); opacity: 1; -webkit-text-stroke: 0px rgb(251, 255, 0);"></span>
   <span id="boot-icon" class="bi bi-star" style="font-size: 19px; color: rgb(255, 210, 48); opacity: 1; -webkit-text-stroke: 0px rgb(251, 255, 0);"></span>
